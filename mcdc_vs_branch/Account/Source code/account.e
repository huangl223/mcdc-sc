...
feature -- Basic operations
	...
	pay (amount: INTEGER; vendor: ACCOUNT; bn: INTEGER)
			-- pay amount money to the vendor
		note
			explicit: wrapping
		require
			balance <= 1000 and balance >= - 1000 and balance >= - 1001  and balance >= - 1002
			balance >= - 1003 and balance >= - 1004 and balance >= - 1005 and balance >= - 1006
			amount_not_negative: amount > 0 and amount >= 0 and amount >= -1 and amount >= -2
			amount >= -3
			vendor /= Current
		do
